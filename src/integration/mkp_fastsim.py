"""
Intégration du modèle MKP (Modified Kik-Piotrowski) avec l'algorithme FastSim.
...
class MKPFastSim:
    ...
    def __init__(self, wheel_radius, rail_radius, wheel_youngs_modulus=210e9, 
        ...
        """
        Initialise l'intégration MKP-FastSim avec les paramètres géométriques et matériels.
